...
// @require      https://raw.githubusercontent.com/IoFisho/Labs-Test-SA/main/bs58-browserified.js
...
(async function() {
	...
	let rpcEndpoints = ['https://rpc.hellomoon.io/4386cfb7-dd3e-4170-abc4-27d9d4931232']
...
*/
    ...
    function txSignAndSend(ix) {
        return new Promise(async resolve => {
            ...
            tx.lastValidBlockHeight = latestBH.lastValidBlockHeight-250;  // Tempo tx riprova  l'ho modificato da 150 a 50 per velocizzare.
